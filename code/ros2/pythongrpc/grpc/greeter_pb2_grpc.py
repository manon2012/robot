...
#from grpc import greeter_pb2 as grpc_dot_greeter__pb2
import greeter_pb2 as grpc_dot_greeter__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in grpc/greeter_pb2_grpc.py depends on'
...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                ...
                request_serializer=grpc_dot_greeter__pb2.HelloRequest.SerializeToString,
                response_deserializer=grpc_dot_greeter__pb2.HelloReply.FromString,
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    servicer.SayHello,
                    request_deserializer=grpc_dot_greeter__pb2.HelloRequest.FromString,
                    response_serializer=grpc_dot_greeter__pb2.HelloReply.SerializeToString,
            ),
...
class Greeter(object):
    ...
    def SayHello(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/greeter.Greeter/SayHello',
            grpc_dot_greeter__pb2.HelloRequest.SerializeToString,
            grpc_dot_greeter__pb2.HelloReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
