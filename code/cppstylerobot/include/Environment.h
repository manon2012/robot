...
DECLARE_ERROR_CODE(INPUT_OUT_OF_PHYSICAL_POSITION_RANGE, SYSTEM_ERROR, 22)  // 输入超出物理限位
DECLARE_ERROR_CODE(CANNOT_SET_VELOCITY_PERCENT_VALUE, SYSTEM_ERROR, 23)     // 不许设置速度百分比值
