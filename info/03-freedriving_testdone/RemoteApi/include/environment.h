...
DECLARE_ERROR_CODE(CART_IMPEDANCE_DECLINED_IN_SAFETY_HANDLE, SYSTEM_ERROR,
                   25)  // 安全处理模式下禁止切换到笛卡尔阻抗模式
...
DECLARE_ERROR_CODE(TCP_POSE_VECTOR_PARAMETER_OUT_OF_RANGE, SYSTEM_ERROR, 28)  // 位姿向量超限
