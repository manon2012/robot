...
DIANA_API int getVelocityPercentValue(/* OUT */ int &value, /* IN */ const char *strIpAddress = "");

DIANA_API int modifyInterferenceZone(/*IN*/ int intIndex, /*IN*/ const char *strRemark,
                                     /*IN*/ const char *strDiagonalName1, /*IN[3]*/ double *dblDiagonal1,
                                     /*IN*/ const char *strDiagonalName2, /*IN[3]*/ double *dblDiagonal2,
                                     /*IN[3]*/ double *dblBiased, /*IN*/ const char *strTcpCoordinate,
                                     /*IN*/ const char *strWPCoordinate, /*IN*/ const char *strIpAddress = "");

DIANA_API int getInterferenceZone(/*IN*/ int intIndex, /*OUT*/ int &intSwitch,
                                  /* int intPriority, */ /*OUT*/ char *strRemark,
                                  /*OUT*/ char *strDiagonalName1, /*OUT[3]*/ double *dblDiagonal1,
                                  /*OUT*/ char *strDiagonalName2, /*OUT[3]*/ double *dblDiagonal2,
                                  /*OUT[3]*/ double *dblBiased, /*OUT*/ char *strTcpCoordinate,
                                  /*OUT*/ char *strWPCoordinate, /*IN*/ const char *strIpAddress = "");

DIANA_API int addInterferenceZoneIO(/*IN*/ int intIndex, /*IN*/ int intDIorDO, /*IN*/ const char *strIOList,
                                    /*IN*/ const char *strIpAddress = "");

DIANA_API int delInterferenceZoneIO(/*IN*/ int intIndex, /*IN*/ int intDIorDO, /*IN*/ const char *strIOList,
                                    /*IN*/ const char *strIpAddress = "");

DIANA_API int getInterferenceZoneIO(/*IN*/ int intIndex, /*IN*/ int intDIorDO, /*OUT*/ char *strIOList,
                                    /*IN*/ const char *strIpAddress = "");

DIANA_API int delInterferenceZone(/*IN*/ int intIndex, /*IN*/ const char *strIpAddress = "");

DIANA_API int controllInterferenceZone(/*IN*/ int intSwitch, /*IN*/ int intIndex = -1,
                                       /*IN*/ const char *strIpAddress = "");

DIANA_API int getInterferenceZoneSwitch(/*IN*/ int &intSwitch, /*IN*/ int intIndex = -1,
                                        /*IN*/ const char *strIpAddress = "");

DIANA_API int getInterpolaterCycleInterval(/*OUT*/ double &dblInterval, /*IN*/ const char *strIpAddress = "");
