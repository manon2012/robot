...
QtModule {
    ...
    staticLibsRelease: []
    dynamicLibsDebug: []
    dynamicLibsRelease: ["/opt/Qt5.12.6/5.12.6/gcc_64/lib/libQt5Network.so","/opt/Qt5.12.6/5.12.6/gcc_64/lib/libQt5Gui.so"]
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: []
    ...
    libFilePathRelease: "/opt/Qt5.12.6/5.12.6/gcc_64/lib/libQt5Multimedia.so.5.12.6"
    ...
    cpp.includePaths: ["/opt/Qt5.12.6/5.12.6/gcc_64/include","/opt/Qt5.12.6/5.12.6/gcc_64/include/QtMultimedia"]
