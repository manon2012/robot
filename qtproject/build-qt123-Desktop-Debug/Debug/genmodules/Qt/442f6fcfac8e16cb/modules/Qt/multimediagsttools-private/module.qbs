...
QtModule {
    ...
    staticLibsRelease: []
    dynamicLibsDebug: []
    dynamicLibsRelease: ["/opt/Qt5.12.6/5.12.6/gcc_64/lib/libQt5MultimediaWidgets.so","asound","gstapp-1.0","gstaudio-1.0","gstvideo-1.0","gstbase-1.0","gstpbutils-1.0","gstreamer-1.0","gobject-2.0"]
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: []
