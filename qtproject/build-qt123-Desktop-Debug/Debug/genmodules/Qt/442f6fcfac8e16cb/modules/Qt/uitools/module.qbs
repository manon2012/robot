...
QtModule {
    ...
    hasLibrary: true
    staticLibsDebug: []
    staticLibsRelease: ["/opt/Qt5.12.6/5.12.6/gcc_64/lib/libQt5Widgets.so","/opt/Qt5.12.6/5.12.6/gcc_64/lib/libQt5Widgets.so","GL"]
    dynamicLibsDebug: []
    dynamicLibsRelease: []
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    ...
    libFilePathRelease: "/opt/Qt5.12.6/5.12.6/gcc_64/lib/libQt5UiTools.a"
    pluginTypes: []
    ...
    cpp.includePaths: ["/opt/Qt5.12.6/5.12.6/gcc_64/include","/opt/Qt5.12.6/5.12.6/gcc_64/include/QtUiTools"]
