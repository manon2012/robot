...
QtModule {
    ...
    staticLibsRelease: []
    dynamicLibsDebug: []
    dynamicLibsRelease: ["/opt/Qt5.12.6/5.12.6/gcc_64/lib/libQt53DExtras.so","/opt/Qt5.12.6/5.12.6/gcc_64/lib/libQt53DQuick.so"]
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: []
    ...
    libFilePathRelease: "/opt/Qt5.12.6/5.12.6/gcc_64/lib/libQt53DQuickExtras.so.5.12.6"
    pluginTypes: []
    ...
    cpp.includePaths: ["/opt/Qt5.12.6/5.12.6/gcc_64/include","/opt/Qt5.12.6/5.12.6/gcc_64/include/Qt3DQuickExtras"]
